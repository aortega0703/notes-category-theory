...
For a category $C$: \parencite{7sketches_compositionality}
\begin{itemize}
  \item Objects:\\
...
Otherwise the category is said to be large. \parencite{nlab:category}
\medskip

\subsection{Arrow properties}
An arrow is said to be: \parencite{categories_working_mathematician}
\begin{itemize}
...
\begin{itemize}
  \item Opposite Category:\\
    ...
    \parencite{nlab:opposite_category}
    \begin{itemize}
      \item Objects:\\
  ...
  \item Set:\\
    ...
    It is a large category and also a locally small one. \parencite{nlab:set}
    \begin{itemize}
      \item Objects:\\
