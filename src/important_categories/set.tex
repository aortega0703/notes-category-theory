...
\begin{definition}[Set\index{Set}]
  ...
  \begin{itemize}
    ...
    \item Morphisms:\\
      $\hom_{\mathrm{Set}}(c, c')$: The set of all functions between sets $c$
      and $c'$.
  \end{itemize}
\end{definition}
    ...
    \begin{description}
      \item[($\implies$)] Consider a non-injective function $f:A\to B$, i.e.
        ...
        \[
          ...
          \end{aligned}
        \]
        Furthermore, $f$ cannot bet monic as it would imply $\bar{x} =
        \bar{y}$. Then by contrapositive, if $f$ is monic then it is
        injective.
