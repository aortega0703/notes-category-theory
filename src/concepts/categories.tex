...
\begin{itemize}
  ...
  \item Morphisms:\\
    ...
    \to b) \in C$ is meant to be read as $f \in \mathrm{hom}_C(a,c)$\\
    The terms morphism and arrows are used interchangeably. They are directed
...
e.g.
% https://q.uiver.app/?q=WzAsMyxbMCwwLCJhIl0sWzEsMCwiYiJdLFsxLDEsImMiXSxbMCwxLCJmIl0sWzEsMiwiZyJdLFswLDIsImdcXGNpcmMgZiIsMl1d
\[\begin{tikzcd}
	a & b \\
	& c
