...
\begin{definition}[Adjoint Functors]\label{def:adjoint_hom}
...
\begin{definition}[Adjoint Functors]\label{def:adjoint_unit_counit}
...
\begin{theorem}[Equivalence of Adjoint Functor Definitions]
