...
\begin{definition}[Initial Morphism]\index{Initial Morphism}
	...
	% https://q.uiver.app/#q=WzAsNSxbMCwwLCJDIl0sWzAsMSwiQyciXSxbMiwwLCJEIl0sWzEsMCwiRihDKSJdLFsxLDEsIkYoQycpIl0sWzAsMSwiaCIsMix7InN0eWxlIjp7ImJvZHkiOnsibmFtZSI6ImRhc2hlZCJ9fX1dLFszLDQsIkYoaCkiLDIseyJzdHlsZSI6eyJib2R5Ijp7Im5hbWUiOiJkYXNoZWQifX19XSxbMiw0LCJmJyJdLFsyLDMsImYiLDJdXQ==
...
\begin{theorem}[Uniqueness of Initial Morphisms]
	...
	\begin{proof}
		...
		% https://q.uiver.app/#q=WzAsMyxbMiwwLCJcXEMiXSxbMSwwLCJcXEQiXSxbMCwwLCJcXHVuZGVybGluZXsxfSJdLFswLDEsIkYiXSxbMiwxLCJcXERlbHRhX0QiLDJdXQ==&macro_url=https%3A%2F%2Fraw.githubusercontent.com%2Faortega0703%2Fnotes-category-theory%2Fmain%2Fsrc%2Fmacros.tex
		\[\begin{tikzcd}[ampersand replacement=\&]
			{\underline{1}} \& \D \& \C
			\arrow["F", from=1-3, to=1-2]
		...
		\begin{itemize}
			...
			\item Morphisms:
				...
				% https://q.uiver.app/#q=WzAsNCxbMCwwLCJGKEMpIl0sWzEsMCwiRihDJykiXSxbMCwxLCJEIl0sWzEsMSwiRCJdLFswLDEsIkYoaCkiXSxbMiwzLCJcXG1hdGhybXtpZH1fRCIsMl0sWzIsMCwiZiJdLFszLDEsImYnIiwyXV0=
				\[\begin{tikzcd}[ampersand replacement=\&]
					{F(C)} \& {F(C')} \\
					D \& D
				...
				\end{tikzcd}
				=
				% https://q.uiver.app/#q=WzAsMyxbMCwwLCJGKEMpIl0sWzAsMSwiRihDJykiXSxbMSwwLCJEIl0sWzAsMSwiRihoKSIsMl0sWzIsMSwiZiciXSxbMiwwLCJmIiwyXV0=
				\begin{tikzcd}[ampersand replacement=\&]
					{F(C)} \& D \\
					{F(C')}
